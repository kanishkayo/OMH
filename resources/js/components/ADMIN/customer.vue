                                        ...
                                        <v-toolbar-items>
                                            ...
                                            <v-dialog v-model="dialogDelete" max-width="500px">
                                                <v-card>
                                                    ...
                                                    dense
                                                    small
                                                    dark text @click="deactivePharmarcy(item)">Deactive</v-btn>
                                                    <v-btn color="#34726f"
                                                    dense
                                                    small
    ...
    data: () => ({
      ...
      rating: 4,
        ...
        headerssm:[
          ...
          { text: 'Inventory items', value: 'full_name', sortable: false },
          { text: 'Actions', value: 'actions', sortable: false },
        ],
